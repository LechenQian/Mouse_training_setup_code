...
class SelinaTraining(Measurement):
    def __init__(self):
        ...
        # RIG 0  RIG 0  RIG 0  RIG 0!!!!!!
        self.mouse = 'C56'  #OT-GC-2

        self.phase = 'deg' #'cond', 'deg','C_control','close','far'
        self.condition = 'Pav'
        self.numtrials = 120

        self.list = [7, 6, 5]
        self.events_path = "C:/Users/MurthyLab/Desktop/Selina_lab_computer_data/experiment_data_2021_8_{0}/{1}/".format(self.condition,self.mouse)
